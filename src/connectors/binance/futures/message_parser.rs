...
impl BinanceFuturesMessageParser {
    ...
    fn parse_order_update(data: &Value) -> Result<ParsedMessage> {
        ...
        let order_update = TradingOrderUpdate {
            ...
            status: match status {
                "NEW" => crate::types::trading::OrderStatus::New,
                "PARTIALLY_FILLED" => crate::types::trading::OrderStatus::PartiallyFilled,
                "FILLED" => crate::types::trading::OrderStatus::Filled,
                "CANCELED" => crate::types::trading::OrderStatus::Canceled,
                "REJECTED" => crate::types::trading::OrderStatus::Rejected,
                "EXPIRED" => crate::types::trading::OrderStatus::Expired,
                _ => crate::types::trading::OrderStatus::New,
            },
            quantity,
            price,
            executed_quantity,
